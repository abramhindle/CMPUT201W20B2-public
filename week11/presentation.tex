...
\section{Week11}
\label{sec:orgb21bf19}
\url{https://github.com/abramhindle/CMPUT201W20B2-public/tree/master/week11}
\subsection{Copyright Statement}
\label{sec:org958cce9}
...
\begin{itemize}
\item 32 in base 16 is  2*pow(16,1) = 0x20
\item 32 in base 10 is  3*pow(10,1) + 2*pow(10,0) = 3*10 + 2*1 = 32
\item 32 in base 8 is   4*pow(8,1) = 4*8 = 32 = 040
\item 32 in base 2 is   1*pow(2,5) = 0b100000

\item 31 in base 16 is  1*pow(16,1) + 15*pow(16,0)
\item 31 in base 10 is  3*pow(10,1) + 1*pow(10,0)
...
\begin{enumerate}
\item Uses of \&
\label{sec:orgf093060}

\begin{enumerate}
\item Checking for bits
\label{sec:org33a8282}
\begin{verbatim}
#include <inttypes.h>
#include <stdio.h>
