...
\begin{enumerate}
\item Uses of \&
\label{sec:orgbfdec69}

\begin{enumerate}
\item Checking for bits
\label{sec:orgf7e20fa}
\begin{verbatim}
#include <inttypes.h>
#include <stdio.h>
